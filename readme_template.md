...
* [dohli](https://github.com/dimkr/dohli) is a DNS-over-HTTPS server that blocks ads. It's easy to deploy your own instance to the cloud, for increased performance, privacy and control.

:: First, this script run UpdateHostsScript.
:: Second, this script will create in first running backup of ORIGINAL/CURRENT hosts file in hosts.skel file.
